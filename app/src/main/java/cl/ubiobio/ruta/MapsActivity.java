...
public class MapsActivity extends AppCompatActivity implements LocationSource, OnMapReadyCallback,
    ...
    private Marker m1 = null;
    private Marker m2 = null;
    LatLng origen = null;
    LatLng destino = null;
    private int count = 0;
    ...
    public void onMapLongClick(LatLng latLng) {
        ...
        markerOptions.title("Haga click en los dos ficheros para trazar la ruta");
        //mMap.clear();
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        if(m1== null){
            ...
            m2 = marker;
            origen = m1.getPosition();
            destino = m2.getPosition();
            String url = obtenerDireccionesURL(origen, destino); //funcion para generar la URL para solicitar la ruta
            m1 = null;
            m2 = null;
            origen = null;
            destino = null;
